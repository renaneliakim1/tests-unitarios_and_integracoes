...
describe("Bateria de Testes - Sistema de Alunos", () => {
  ...
  test("CT-05 - Deve validar erro para valor de nota não numérica", () => {
    expect(() => sistema.calcularMedia(7, 8, 9, "dez")).toThrow(
      "Todas as notas devem ser parâmetros numéricos.",
    );
  });
});
